declare module '@floating-ui/dom' {
	...
	export type ArrowOptions = Prettify<Omit<ArrowOptions_2, 'element'> & {
	    element: Element;
	}>;
	...
	export type AutoPlacementOptions = Prettify<Omit<AutoPlacementOptions_2, 'boundary'> & DetectOverflowOptions>;
	 ...
	 */
	export function autoUpdate(reference: ReferenceElement, floating: FloatingElement, update: () => void, options?: AutoUpdateOptions): () => void;
	 ...
	 */
	export const computePosition: (reference: ReferenceElement, floating: FloatingElement, options?: Partial<ComputePositionConfig>) => Promise<ComputePositionReturn>;
	
	export type ComputePositionConfig = Prettify<Omit<ComputePositionConfig_2, 'middleware' | 'platform'> & {
	    /**
	 ...
	 */
	export const detectOverflow: (state: MiddlewareState, options?: DetectOverflowOptions | Derivable<DetectOverflowOptions>) => Promise<SideObject>;
	
	export type DetectOverflowOptions = Prettify<Omit<DetectOverflowOptions_2, 'boundary'> & {
	    boundary?: Boundary;
	}>;
	...
	export type FlipOptions = Prettify<Omit<FlipOptions_2, 'boundary'> & DetectOverflowOptions>;
	...
	export type HideOptions = Prettify<Omit<HideOptions_2, 'boundary'> & DetectOverflowOptions>;
	...
	export type Middleware = Prettify<Omit<Middleware_2, 'fn'> & {
	...
	export type MiddlewareState = Prettify<Omit<MiddlewareState_2, 'elements'> & {
	    elements: Elements;
	}>;
	...
	export type OffsetOptions = OffsetValue | Derivable<OffsetValue>; type OffsetValue = number | {
	    /**
	...
	export const platform: Platform; type Prettify<T> = {
	    [K in keyof T]: T[K];
	...
	export type ShiftOptions = Prettify<Omit<ShiftOptions_2, 'boundary'> & DetectOverflowOptions>;
	...
	export type SizeOptions = Prettify<Omit<SizeOptions_2, 'apply' | 'boundary'> & DetectOverflowOptions & {
	    /**
