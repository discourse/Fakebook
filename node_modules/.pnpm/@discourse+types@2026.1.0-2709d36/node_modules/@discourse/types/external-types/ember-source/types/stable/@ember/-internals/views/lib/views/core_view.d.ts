declare module '@ember/-internals/views/lib/views/core_view' {
    ...
    */
    ...
    const CoreView_base: Readonly<typeof import("@ember/object").default> & (new (owner?: import("@ember/owner").default | undefined) => import("@ember/object").default) & import("@ember/object/mixin").default;
