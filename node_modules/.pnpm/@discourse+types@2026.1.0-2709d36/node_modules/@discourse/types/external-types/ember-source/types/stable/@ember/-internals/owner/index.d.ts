declare module '@ember/-internals/owner' {
    ...
    /**
      @private
     */
    type ResolveFactoryManager<Type extends string, Name extends string> = Type extends ValidType ? Name extends ValidName<Type> ? DIRegistry[Type][Name] extends infer RegistryEntry extends object ? FactoryManager<RegistryEntry> : FactoryManagerDefault : FactoryManagerDefault : FactoryManagerDefault;
    type FactoryManagerDefault = FactoryManager<object> | undefined;
    type Lookup<Type extends string, Name extends string> = Type extends ValidType ? Name extends ValidName<Type> ? DIRegistry[Type][Name] : unknown : unknown;
    /**
    ...
    interface BasicContainer {
        /**
         ...
         @return {any}
         */
        lookup<Type extends string, Name extends string>(fullName: FullName<Type, Name>, options?: RegisterOptions): Lookup<Type, Name>;
        /**
        ...
        */
        factoryFor<Type extends string, Name extends string>(fullName: FullName<Type, Name>): ResolveFactoryManager<Type, Name>;
    }
    /**
