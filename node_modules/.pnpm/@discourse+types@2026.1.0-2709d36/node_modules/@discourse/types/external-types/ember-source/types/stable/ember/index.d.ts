declare module 'ember' {
    ...
    */
    ...
    namespace Ember {
        ...
        const ComponentLookup: Readonly<typeof EmberObject> & (new (owner?: import("@ember/owner").default | undefined) => EmberObject) & {
            componentFor(name: string, owner: import("@ember/-internals/owner").InternalOwner): import("@ember/owner").FactoryManager<object> | undefined;
            layoutFor(name: string, owner: import("@ember/-internals/owner").InternalOwner, options: import("@ember/owner").RegisterOptions): unknown;
        };
        ...
        const Debug: {
            registerDeprecationHandler: (handler: import("@ember/debug/lib/handlers").HandlerCallback<EmberDebug.DeprecationOptions>) => void;
