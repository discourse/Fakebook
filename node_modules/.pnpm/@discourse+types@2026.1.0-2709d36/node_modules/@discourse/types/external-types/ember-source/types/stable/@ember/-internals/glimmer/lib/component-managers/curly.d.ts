declare module '@ember/-internals/glimmer/lib/component-managers/curly' {
    ...
    import type { Bounds, CompilableProgram, Destroyable, ElementOperations, Environment, InternalComponentCapabilities, PreparedArguments, VMArguments, WithCreateInstance, WithDynamicLayout, WithDynamicTagName } from "@glimmer/interfaces";
