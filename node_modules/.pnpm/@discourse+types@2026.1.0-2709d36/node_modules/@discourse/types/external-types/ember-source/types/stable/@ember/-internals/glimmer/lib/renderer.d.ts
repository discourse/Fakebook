declare module '@ember/-internals/glimmer/lib/renderer' {
    ...
    import type { Bounds, Cursor, DebugRenderTree, DynamicScope as GlimmerDynamicScope, Environment, RenderResult, Template, TemplateFactory, EvaluationContext, TreeBuilder } from "@glimmer/interfaces";
    ...
    class RootState {
        ...
        constructor(root: Component | OutletView, context: EvaluationContext, owner: InternalOwner, template: Template, self: Reference<unknown>, parentElement: SimpleElement, dynamicScope: DynamicScope, builder: IBuilder);
    ...
    export class Renderer {
        ...
        constructor(owner: InternalOwner, document: SimpleDocument, envOptions: {
