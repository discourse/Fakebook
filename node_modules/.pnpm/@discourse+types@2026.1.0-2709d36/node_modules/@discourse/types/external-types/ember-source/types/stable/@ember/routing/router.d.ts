declare module '@ember/routing/router' {
    ...
    */
    ...
    const EmberRouter_base: Readonly<typeof EmberObject> & (new (owner?: Owner | undefined) => EmberObject) & import("@ember/object/mixin").default;
    /**
    ...
    */
    ...
    let defaultActionHandlers: {
        willResolveModel<R extends Route<unknown>>(this: EmberRouter, _routeInfos: InternalRouteInfo<Route>[], transition: Transition, originRoute: R): void;
