declare module '@ember-compat/tracked-built-ins/-private/map' {
...
declare module '@ember-compat/tracked-built-ins/-private/set' {
...
declare module '@ember-compat/tracked-built-ins/-private/array' {
...
declare module '@ember-compat/tracked-built-ins/-private/decorator' {
	...
	import TrackedArray from '@ember-compat/tracked-built-ins/-private/array'; function tracked<T>(obj: T[] | typeof Array): TrackedArray<T>; function tracked<T>(obj: Set<T> | typeof Set): TrackedSet<T>; function tracked<T, U>(obj: Map<T, U> | typeof Map): TrackedMap<T, U>; function tracked<T extends object>(obj: WeakSet<T> | typeof WeakSet): TrackedWeakSet<T>; function tracked<T extends object, U>(obj: WeakMap<T, U> | typeof WeakMap): TrackedWeakMap<T, U>; function tracked<T extends object>(obj: T | typeof Object): T; function tracked(obj: object, key: string | symbol, desc?: PropertyDescriptor): void;
	export { tracked as default };

}
declare module '@ember-compat/tracked-built-ins/-private/object' {
...
declare module '@ember-compat/tracked-built-ins/-private/validator-versions' {
